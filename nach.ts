...
async function createNachaFile(fileName: string, debits: Debit[], credits: Credit[]) {
  const file = new File({
    immediateDestination: '071026408',
    immediateOrigin: '071026408',
    immediateDestinationName: 'Met CAP',
    immediateOriginName: 'CFX Labs INC',
    referenceCode: '#A000001',
  });

  const batch = new Batch({
    serviceClassCode: '200',
    companyName: 'CFX Labs INC',
    standardEntryClassCode: 'PPD',
    companyIdentification: '872289669',
